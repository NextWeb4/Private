...
- `index.html`, `about.html`, and `404.html` are entry pages; `article/` contains 562 generated article pages, `module/` contains three category pages, `data/` contains eight search files, `uploads/` contains 74 public media files, and the root contains four public maintenance documents in the next validated deployment.
...
- The verified source is `website-source-v2`, whose workflow publishes to `NextWeb4/Private`; do not invent a runtime-local generator or hand-edit generated batches.
